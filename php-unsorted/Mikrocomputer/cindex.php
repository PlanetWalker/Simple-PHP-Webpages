            ...
            <form action="" method="get">
                ...
                <h4>Geben Sie Ihre pers&ouml;nliche Daten an:
                    ...
                    <table id="up">
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["nachnahme"])) ? '<p>Bitte Nachnahmen angeben!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                         ...
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["vorname"])) ? '<p>Bitte Vorname angeben!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                         ...
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["email"])) ? '<p>Bitte E-Mail Adresse angeben!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table id="down">
                        <tr>
                         ...
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["stiftleisten"])) ? '<p>Bitte eines ausw&auml;hlen!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                         ...
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["cpu"])) ? '<p>Bitte eines ausw&auml;hlen!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                         ...
                         <tr id="red">
                            <td colspan="2">
                                <?php echo (empty($_GET["ram"]) && empty($_GET["rom"])) ? '<p>Bitte eines ausw&auml;hlen!<p>': '' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
