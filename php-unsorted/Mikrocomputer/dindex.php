...
<html lang="de">
    ...
    <body>
        ...
        <div id="apply">
            ...
            (!empty($_GET["stiftleisten"]) ? (($_GET["stiftleisten"] == "add") ? '<p>Mikrocomputer 106.- &euro;</p>' + $gesamtkosten += 106: '') : '');
            (!empty($_GET["stiftleisten"]) ? (($_GET["stiftleisten"] == "remove") ? '<p>Mikrocomputer 116.- &euro;</p>'+ $gesamtkosten += 116: '') : '');

            (!empty($_GET["cpu"]) ? (($_GET["cpu"] == "12") ? '<p>Mikroprozessor 15.- &euro;</p>' + $gesamtkosten += 15: '') : ''); 
            (!empty($_GET["cpu"]) ? (($_GET["cpu"] == "18") ? '<p>Mikroprozessor 20.- &euro;</p>' + $gesamtkosten += 20: '') : ''); 
    
            (!empty($_GET["ram"]) ? (($_GET["ram"] == "add") ? '<p>RAM Speicher 10.- &euro;</p>' + $gesamtkosten += 10: '') : '');
            (!empty($_GET["rom"]) ? (($_GET["ram"] == "add") ? '<p>ROM Speicher 12.- &euro;</p>' + $gesamtkosten += 12: '') : '');
