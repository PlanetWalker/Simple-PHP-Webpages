                    ...
                    <table id="up">
                        ...
                        <tr>
                            <td>
                             ...
                             <td>
                                <input type="text" name="nachnamen" size="15" value="<?php echo (empty($_GET["nachnamen"])) ? !isset($_GET["submit"]) ? 'Mustermann': '': $_GET["nachnamen"]; ?>">
                            </td>
                        </tr>
                         <tr id="red">
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="vorname" size="15" value="<?php echo (empty($_GET["vorname"])) ? !isset($_GET["submit"]) ? 'Max': '': $_GET["vorname"]; ?>">
                            </td>
                        </tr>
                         <tr id="red">
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="email" name="email" size="15" value="<?php echo (empty($_GET["email"])) ? !isset($_GET["submit"]) ? 'max@muster.de': '': $_GET["email"]; ?>">
                            </td>
                        </tr>
                    </table>
                    <table id="down">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="stiftleisten" value="remove" <?php echo (!empty($_GET["stiftleisten"]) ? (($_GET["stiftleisten"] == "remove") ? 'checked': '') : !isset($_GET["submit"]) ? 'checked': ''); ?>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="cpu" value="12" <?php echo (!empty($_GET["cpu"]) ? (($_GET["cpu"] == "12") ? 'checked': '') : !isset($_GET["submit"]) ? 'checked': ''); ?>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="ram" value="add" <?php echo (!empty($_GET["ram"])) ? (($_GET["ram"] == "add") ? 'checked': '') : !isset($_GET["submit"]) ? 'checked': ''; ?>>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" name="rom" value="add" <?php echo (!empty($_GET["rom"])) ? (($_GET["rom"] == "add") ? 'checked': '') : !isset($_GET["submit"]) ? 'checked': ''; ?>>
                            </td>
                        </tr>
                    </table>
                <hr>
